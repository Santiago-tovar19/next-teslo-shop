"use client";
import { generatePaginationNumbers } from "@/utils/generationPaginationNumbers";
          ...
          {allPages.map((page) => {
            return (
              <li key={page} className="page-item">
                <Link
                  className={`page-link relative block py-1.5 px-3  border-0 outline-none transition-all duration-300 rounded text-gray-800 hover:text-gray-800 hover:bg-gray-200 focus:shadow-none mr-2 ${
